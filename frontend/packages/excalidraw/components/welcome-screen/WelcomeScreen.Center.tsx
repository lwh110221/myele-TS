...
const LogoWithDesktop = () => {
  return (
    <div style={{ display: "flex", alignItems: "center" }}>
      <ExcalidrawLogo withText />
      <span style={{ marginLeft: "10px", fontSize: "1.2rem", color: "var(--color-logo-text)", fontWeight: "bold" }}>
        桌面版
      </span>
    </div>
  );
};
LogoWithDesktop.displayName = "LogoWithDesktop";
